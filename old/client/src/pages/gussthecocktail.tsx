...
export const gussthecocktail: NextPage = () => {
  ...
  const [drinkInfo, setDrinkInfo] = useState([
    { strDrink: "California Lemonade", idDrink: "11205" },
    { strDrink: "Bloody Maria", idDrink: "11112" },
    { strDrink: "Alexander", idDrink: "11014" },
    { strDrink: "Gin Toddy", idDrink: "11420" },
  ]);
  ...
  return (
    <>
      ...
      {!inLobby ? (
        <Gamejoincreate gameType="cocktail" />
      ) : (
