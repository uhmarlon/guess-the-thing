    ...
    <Viewhead>
      <main className="text-white flex flex-col items-center justify-center mt-8 md:mt-6 mb-12 md:mb-2">
        <motion.div
          ...
          initial={{ opacity: 0 }}
        >
          <h1 className="text-3xl font-bold mb-2">Guess The Price</h1>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="col-span-1 md:col-span-3 flex flex-col space-y-4">
              ...
              {/* Disclamer for Alpha Game with Bugs */}
              <div className="bg-gttred  py-2 px-4 inline-block mb-4 rounded-md">
                This game is in Alpha. Please report any issues.
              </div>
            </div>
          </div>
